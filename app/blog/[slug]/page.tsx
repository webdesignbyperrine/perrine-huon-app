...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    title,
    description,
    alternates: { canonical: `https://www.perrinehuon.com/blog/${slug}` },
    openGraph: {
      title,
      description,
      type: 'article',
      url: `https://www.perrinehuon.com/blog/${slug}`,
...
export default async function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-paper">
      <BreadcrumbJsonLd
        items={[
          { name: 'Accueil', url: 'https://www.perrinehuon.com' },
          { name: 'Blog', url: 'https://www.perrinehuon.com/blog' },
          { name: post.title, url: `https://www.perrinehuon.com/blog/${slug}` },
        ]}
      />
      <ArticleJsonLd
        headline={post.title}
